...
#define SERVO_1_CHANNEL TIM_CHANNEL_2
#define SERVO_2_CHANNEL TIM_CHANNEL_3
#define SERVO_3_CHANNEL TIM_CHANNEL_4

// 舵机的PWM值(范围为500-2500)

// 舵机1的PWM值
#define SERVO_1_OPEN 2300
#define SERVO_1_CLOSE 1400

// 舵机2的PWM值
#define SERVO_2_OPEN 800
#define SERVO_2_CLOSE 1650

// 舵机3的PWM值
#define SERVO_3_OPEN 2000
#define SERVO_3_CLOSE 1000
